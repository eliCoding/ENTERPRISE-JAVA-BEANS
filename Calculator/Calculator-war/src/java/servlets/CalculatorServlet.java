...
import calculator.ejb.CalculatorEJBLocal;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                out.printf("<p>%.2f  + %.2f = %.2f</p>\n", val1, val2, calc.add(val1,val2));

            } catch (NumberFormatException | NullPointerException e) {
                out.println("<p><b>Error: invalid data submitted</b></p>");
            }
            out.println("</body>");
            out.println("</html>");
        }
